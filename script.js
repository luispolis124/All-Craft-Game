...
const elements = {
    ...
    "Hagar": "🏺", "Lot": "🧂", "Dragon": "🐉", "Cat": "🐱", "Bird": "🐦", "Lion": "🦁", "Tiger": "🐯", "King": "👑", 
...
const recipes = {
    ...
    "Ocean+Earth": "Island", "Mountain+Lava": "Volcano", "Volcano+Energy": "Eruption", "Tree+Tree": "Forest", 
    
    // RECEITA DA SELVA (JUNGLE)
    "Forest+Swamp": "Jungle", 
    ...
    "Idea+Copyright": "Patent", "Author+Idea": "Creativity", "Energy+Space": "God",
    
    // Linhagem Bíblica
    "Human+Farm": "Cain", "Human+Life": "Abel", "Human+Ocean": "Noah", "Noah+Book": "Shem", "Noah+Tool": "Ham", "Noah+Planet": "Japheth",
    "God+Adam": "Abraham", "Abraham+Eve": "Sarah", "Abraham+Sarah": "Isaac", "Abraham+Sand": "Hagar",
    "Abraham+Hagar": "Ishmael", "Abraham+City": "Lot", "Isaac+Sarah": "Rebekah", "Isaac+Rebekah": "Jacob", "Isaac+Pottery": "Esau",

    // RECEITAS DOS ANIMAIS E CRIATURAS
    "Lava+Lava": "Dragon",
    "Life+House": "Cat",
    "Life+Air": "Bird",
    "Life+Forest": "Lion",
    ...
    // Meta-Elementos
    "Cain+Cain": "City", "Abel+Fire": "Sacrifice", "Noah+Mountain": "Ark", "Tool+Human": "Craft", 
    "God+Time": "Infinite", "Infinite+Craft": "Infinitecraft", "Infinite+Infinitecraft": "All", "All+Craft": "Allcraft"
};
